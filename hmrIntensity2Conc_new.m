...
function [dc, dod] = hmrIntensity2Conc( d, SD, t, hpf, lpf, ppf )
...
fs=1/(t(2)-t(1));
% % dod = hmrMotionCorrectSplineSG(dod, d, t, SD, 0.99, 20);
% % % dod=sgolayfilt(dod,3,351);
%  dod = hmrMotionCorrectWavelet(dod,SD,0.1);
